...
const Home = () => {
  return (
    <div>
        <div className="bg-cover bg-center bg-[url(https://www.slashgear.com/img/gallery/what-are-those-little-cameras-above-traffic-lights-actually-for/intro-1757927181.jpg)]   h-screen pt-8  flex justify-between flex-col  w-full" >
